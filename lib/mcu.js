...
function updateIce(stunOn){
    ...
    setTimeout(updateIce, 86400000);
    //setInterval(updateIce, 5000);
}

function staticIce(stunOn){
    ...
    if(stunOn) {
        urls.append("stun:u1.xirsys.com");
    }
    iceConfig = { 
        username: "9UGvMXWnDA-2smC8VzBPIOiOFRdtxZ0QFq3u7iDl2BNwqL005VuHhotuJwXv2LkKAAAAAF1ciUpib3Zhdg==",
        credential: "7e56f6e8-c3a6-11e9-bf7c-f676af1e4042",
        urls: urls
    }

    console.log("STATIC ICE List: ", iceConfig);
}
